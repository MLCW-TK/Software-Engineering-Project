...
//		cc.listIngredients("Raclettefoo");
		...
		cc.addContactInfo("Mario", "345678", "email", "mario@email.com");
		System.out.println("");
		...
		cc.addContactInfo("Mario", "345678", "phone number", "06 12 34 56 78");
		System.out.println("");
		
		System.out.println("Test associateCard");
		System.out.println("----------");
		ClientUser mario = ClientConsole.re1.getUserFromUserName("Mario");
		cc.associateCard("Mario", "34567",  "BasicFidelityCard");
		cc.associateCard("Mario", "34567",  "PointFidelityCard");
		cc.associateCard("Mario", "34567", "LotteryFidelityCard");
		try {
			// this is supposed to fail, because DummyFidelityCard does not exist
			cc.associateCard("Mario", "34567", "DummyFidelityCard");
