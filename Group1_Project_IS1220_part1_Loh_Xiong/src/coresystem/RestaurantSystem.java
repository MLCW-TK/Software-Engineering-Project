...
public class RestaurantSystem implements Publisher{
	...
	/**
	 * return the ArrayList of the subscriber_list
	 * @return
	 */
	public ArrayList<Subscriber> getSubscriber_list(){
	...
	/**
	 * notify all subscribers of automatically generated special offers
	 */
	@Override
	...
	/**
	 * notify all subscribers with a message about a particular meal
	 */
	@Override
	 ...
	 * notify all subscribers who are on their birthday 
	 */
	...
	/**
	 * return a String of birthday special offer for the user
	 * @param sub
	 * @return
	 */
	...
	/**
	 * return a String which summarized all the meals on special offer
	 * @return
	 */
	...
	/**
	 * return a String for the Subscriber in a normal day
	 * @param sub
	 * @return
	 */
	...
	public void refresh(){
		...
		if(!this.getUser_list().isEmpty()){
			for(Subscriber client: this.getUser_list()){
				if(client.getReceiveUpdates() && ((User) client).getCanReceiveSpecialOffers()&& !this.getSubscriber_list().contains(client)){
					try{
	...
	/**
	 * return the special offer message
	 * @return
	 */
