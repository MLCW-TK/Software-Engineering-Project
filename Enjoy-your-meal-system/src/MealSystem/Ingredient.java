...
public class Ingredient {
	...
	public Ingredient(String name, double priceperquantity){
		...
		this.totalprice = round(this.quantity * this.priceperquantity,2);
	}
	...
	public Ingredient(String name, double quantity, double priceperquantity){
		...
		this.priceperquantity = priceperquantity;
		this.totalprice = round(this.priceperquantity * this.quantity,2);
	...
	public void addQuantity(double quantity){
		this.quantity = quantity;
		this.totalprice = round(priceperquantity * this.quantity,2);
	}
